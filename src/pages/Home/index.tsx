...
var detectWrap = function(className: string) {
  var wrappedItems: Element[] = [];
  var prevItem: DOMRect | undefined;
  var currItem: DOMRect | undefined;
...
function Home() {
  ...
  for (var i = 0; i < items.length; i++) {
    items[i].classList.remove(styles.wrapped);
  }
  var wrappedItems = detectWrap('item');
  console.info(wrappedItems.length);
  for (var k = 0; k < wrappedItems.length; k++) {
    wrappedItems[k].classList.add(styles.wrapped);
  }*/
  ...
  return (
    <div className="container">
      ...
      <div
        className={`page-content ${isDarkMode ? "light" : "dark"} ${
          styles.pageMargin
        }`}
      >
        ...
        <div id="resume">
          Programador Full Stack apaixonado por aprender novas tecnologias e
          viciado em programação, sempre procurando formas de melhorar o código
          e otimizar sua eficiência. Com mais de 4 anos de experiencia em
          desenvolvimento de softwares, sistemas e interfaces gráficas e com
          conhecimento sobre as linguagens e tecnologias mais usadas no mercado.
          Atualmente cursando Ciência da Computação na Universidade Anhembi
          Morumbi e Top 50 no ranking de desenvolvedores C# no Brasil pela
          CodersRank.
        </div>
        <div id="languages" className={styles.languages}>
          <div className={`${styles.circle} animate__animated animate__fadeInUp ${styles.c1}`}>
          ...
          <div className={`${styles.circle} animate__animated animate__fadeInUp ${styles.c2}`}>
            <svg viewBox="0 0 128 128">
              <path
                fill="#ededed"
          ...
          <div className={`${styles.circle} animate__animated animate__fadeInUp ${styles.c3}`}>
            <svg viewBox="0 0 128 128">
              <path
                fill="#ededed"
          ...
          <div className={`${styles.circle} animate__animated animate__fadeInUp ${styles.c4}`}>
            <svg viewBox="0 0 128 128">
              <path
                fill="#ededed"
